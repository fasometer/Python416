...
from .models import Product, ProductCategory, Photo, Basket
...
class PhotoAdd(admin.StackedInline):  # из одной модели в другую
    model = Photo
    fields = ('product', 'add_photo')
    extra = 0   # убрать лишние строки
        ...
        if request.method == "POST":
            ...
            for x in csv_data:
                ...
                Product.objects.update_or_create(
                    ...
                    price=fields[5],
                    quantity=fields[6],
                    category=ProductCategory(fields[7][0])  # связь
                )
            return redirect('admin:index')
